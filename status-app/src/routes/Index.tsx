...
import { ArrowRight, MessageSquare, Mail, Download, Apple, Monitor } from "lucide-react";
...
export function Index() {
  ...
  return (
    <AppLayout>
      ...
      {/* Vertical spacer between cards and download */}
      <div className="py-8 md:py-10" aria-hidden />

      {/* Téléchargement — desktop app */}
      <section id="telechargement" className="container-wide pt-32 pb-16 scroll-mt-32 overflow-x-clip">
        <Reveal direction="left" distance={80} className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-white/50 leading-relaxed">
            Gère tes serveurs Discord depuis une app native, avec mises à jour automatiques signées et statut temps réel.
          </p>
        </Reveal>
        <RevealStagger className="grid md:grid-cols-2 gap-8 md:gap-10" staggerChildren={0.1} delayChildren={0.15}>
          {/* macOS — disponible */}
                ...
                <div className="flex items-start gap-6 h-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-white/55 leading-relaxed mb-5">
                      Apple Silicon (M1/M2/M3/M4). macOS 11 Big Sur ou plus récent. Mises à jour automatiques signées.
                    </p>
                    <span className="inline-flex items-center gap-1.5 text-xs font-bold text-white/70 group-hover:text-white group-hover:gap-2 transition-all">

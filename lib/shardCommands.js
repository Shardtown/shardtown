...
function buildCommandList() {
    return [
        ...
        // /promo — gestion des codes de réduction Shardtown Premium.
        // Restreinte au(x) bot-owner(s) (env SHARDTOWN_OWNER_ID) côté
        // handler. Pas de setDefaultMemberPermissions ici parce que ces
        // codes sont gérés à l'échelle Shardtown, pas par les admins
        // des serveurs où le bot tourne.
        new SlashCommandBuilder()
            .setName('promo')

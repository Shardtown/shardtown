...
router.put('/config/:guildId', requireAuth, express.json(), async (req, res) => {
    ...
    try {
        const allowed = ['categories', 'staff_roles', 'admin_roles', 'transcript_channel_id', 'log_channel_id', 'max_tickets_per_user', 'afk_timeout_minutes', 'panel_title', 'panel_description', 'panel_footer', 'panel_color'];

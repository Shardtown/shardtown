...
// applique la presence/activity configurée, et expose pushIdentity() pour
// pousser nom/avatar/bannière sur l'application Discord via PATCH /users/@me.
//
// Note : on n'attache AUCUN listener métier (messageCreate, interactionCreate,
// …) ici. Ce manager garde juste la session ouverte et l'identité à jour.
// Le code métier reste celui du bot Shard officiel ; quand le worker code
// arrivera, il sera factorisé pour tourner aussi sur ces clients.
...
async function start(row) {
    ...
    // Intents minimaux : on ne consomme rien, on garde juste la session.

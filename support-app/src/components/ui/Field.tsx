  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen(o => !o)}
        className={`w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-xl bg-white/[0.02] border ${
          open ? "border-white/25 bg-white/[0.04]" : "border-white/[0.08]"
        } hover:bg-white/[0.05] hover:border-white/15 transition-colors text-left text-sm`}
      >
